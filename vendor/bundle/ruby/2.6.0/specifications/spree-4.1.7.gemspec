...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_runtime_dependency(%q<spree_backend>.freeze, ["= 4.1.7"])
    s.add_runtime_dependency(%q<spree_frontend>.freeze, ["= 4.1.7"])
    s.add_runtime_dependency(%q<spree_sample>.freeze, ["= 4.1.7"])
    s.add_runtime_dependency(%q<spree_cmd>.freeze, ["= 4.1.7"])
  else
    s.add_dependency(%q<spree_core>.freeze, ["= 4.1.7"])
    s.add_dependency(%q<spree_api>.freeze, ["= 4.1.7"])
    s.add_dependency(%q<spree_backend>.freeze, ["= 4.1.7"])
    s.add_dependency(%q<spree_frontend>.freeze, ["= 4.1.7"])
    s.add_dependency(%q<spree_sample>.freeze, ["= 4.1.7"])
    s.add_dependency(%q<spree_cmd>.freeze, ["= 4.1.7"])
  end
end
